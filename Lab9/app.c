...
SL_WEAK void app_init(void)
{
  ...
  // Configure button interrupt for both edges
    ...
    case sl_bt_evt_gatt_server_characteristic_status_id:
      if (gattdb_BUTTON_IO == evt->data.evt_gatt_server_characteristic_status.characteristic) {
          if (evt->data.evt_gatt_server_characteristic_status.client_config_flags & sl_bt_gatt_notification) {
              app_log("Notification enabled for BUTTON characteristic\r\n");
              // Set flag that will be used in application logic
              // for generating notifications
              button_io_notification_enabled = true;
          }
          else {
              app_log("Notification disabled for BUTTON characteristic\r\n");
              // Reset flag
